-- ==================== CORRECTION DU SYSTÈME D'ABONNEMENT ====================
-- Ce script corrige le problème d'accès après activation d'un compte

-- ÉTAPE 1: Créer la table users si elle n'existe pas (selon la configuration)
...
-- ÉTAPE 2: Migrer les données de user_profiles vers users si elles existent
...
-- ÉTAPE 3: Corriger la fonction get_all_users_for_admin pour utiliser la table users
...
-- ÉTAPE 4: Corriger les autres fonctions pour utiliser la table users
...
BEGIN
    ...
    IF NOT FOUND THEN
        ...
        SELECT 
            ...
            CASE WHEN new_status = 'active' THEN CURRENT_DATE ELSE NULL END,
            new_end_date,
...
-- ÉTAPE 5: Corriger la fonction update_user_info_admin
...
-- ÉTAPE 6: Corriger la fonction delete_user_admin
...
-- ÉTAPE 7: Créer une fonction pour mettre à jour la dernière connexion
...
-- ÉTAPE 8: Recréer la vue admin_stats pour utiliser la table users
...
-- ÉTAPE 9: Activer RLS sur la table users
ALTER TABLE public.users ENABLE ROW LEVEL SECURITY;

-- ÉTAPE 10: Créer les politiques RLS pour la table users
